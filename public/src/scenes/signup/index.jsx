...
const SignupForm = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    const { firstname, lastname, email, password, confirmPassword, contact, role } = formData;
  ...
  return (
    <div className="signup-form-container" style={{ backgroundColor: colors.primary[500] }}>
      {/* Profile Image and Camera Icon */}
      <div className="profile-container">
        <div className="profile-image-wrapper">
          <img
            src={selectedImage ? URL.createObjectURL(selectedImage) : "https://via.placeholder.com/150"} // Preview selected image
            alt="Profile"
